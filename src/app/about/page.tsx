    ...
    <div className="w-full min-h-screen p-6 md:p-12 bg-gray-100 dark:bg-gray-800">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-lg text-gray-700 dark:text-gray-300 mb-12 leading-relaxed">
          I&apos;ve always been drawn to hard problems. I started with competitive
          programming and machine learning in university, spent three years
          shipping at a late-stage startup, and joined as the first engineering
          hire at an early-stage company building LLM-powered products. Along
          the way I&apos;ve tried to get genuinely good at whatever I commit
          to — here&apos;s the arc, in order.
        </p>
        ...
        <div className="space-y-0">
          <TimelineEntry period="High School" title="Academic & Extracurricular">
            <ul className="list-disc list-inside space-y-2">
              <li>
                Member of the school quizzing team and athletics team (100m,
                200m, and 4×100m relay).
              </li>
          ...
          >
            <ul className="list-disc list-inside space-y-2">
              <li>
                University project: applied convolutional neural networks to
                detect cervical cancer from pap smear images.
              </li>
              <li>
                Built a working understanding of ML architectures that I still
                draw on today.
              </li>
            </ul>
          </TimelineEntry>
          ...
          >
            <ul className="list-disc list-inside space-y-2">
              <li>
                ...
                represented the university at ICPC regionals in the 2018–19
                season.
              </li>
              <li>
              ...
              <li>
                ...
                Structures &amp; Algorithms course — the only time relative
                grading produced a single top scorer in the program&apos;s
                history.
              </li>
            </ul>
          </TimelineEntry>
          ...
          >
            <ul className="list-disc list-inside space-y-2">
              <li>
                Contributed to the MOSAIC platform on the Goldman Sachs
          ...
          >
            <ul className="list-disc list-inside space-y-2">
              <li>
                Three years across multiple product teams — tally, desktop,
                reports, MAX TAX, forms, and recon.
              </li>
              <li>
                Built frontends from scratch for 0→1 products and org-wide
                rewrites spanning 30+ enterprise reports as microfrontends.
              </li>
              <li>
          ...
          >
            <ul className="list-disc list-inside space-y-2">
              <li>
                First engineering hire at an early-stage startup building
                products enabled by advances in LLMs.
              </li>
              <li>
          ...
          >
            <ul className="list-disc list-inside space-y-2">
              ...
              <li>
                Six-month focused body recomposition, dieting down to roughly
                10% body fat.
              </li>
